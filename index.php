  ...
  background-color: #45a049;
    ...
    <!-- Testimonial End -->
			...
			<div class="chatbot-icon">
			  <img src="img/chat.png" alt="Chatbot Icon">
			</div>
			...
			<div class="chatbot-container">
			  ...
			  <div class="chatbox" id="chatbox">
				<span class="close-button" onclick="closeChatbox()" style="margin-left:550px;"><b>X</b></span>
				<!-- This is where the iframe will be inserted -->
			  </div>
			</div>
...
<script>
  function toggleChatbox() {
    ...
    iframe.src = 'chat/chat_new.php'; // URL of the page to load in the iframe
    iframe.width = '100%';
    iframe.height = '100%';
    iframe.style.border = 'none';

    if (chatbox.firstChild) {
      // If chatbox already contains an iframe, remove it before inserting the new one
