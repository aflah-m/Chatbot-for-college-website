                ...
                <div class="col-lg-8 col-md-12 wow fadeInUp" data-wow-delay="0.5s">
                    <form method="POST" action="redirect.php">
                        <div class="row g-3">
                            ...
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <input type="password" class="form-control" name="password" placeholder="Your Email">
                                    <label for="email">Password</label>
                                </div>
                            </div>
                            <div class="col-12">
                                <button name="login" class="btn btn-primary w-100 py-3" type="submit">Submit</button>
                            </div>
                        </div>
                    </form>
                </div>
